...
// dashboard/orders.php's list query, just LIMITed - this is the page's
// initial (no-JS) render; dashboard/dashboard-recent-orders.php re-runs
...
<body class="admin-body">
        ...
        <div class="admin-main">
            ...
            <div class="admin-content">
                ...
                <!-- ==========================================================
                     ...
                     dashboard/dashboard-recent-orders.php (see admin-dashboard.js)
                     - same table markup/classes as dashboard/orders.php, so no
                ...
                <div class="admin-table-card admin-recent-orders-card">
                    ...
                    <table class="admin-table" id="recent-orders-table">
                        ...
                        <tbody id="recent-orders-tbody"
                               data-notification-sound="<?= asset_url('dashboard/assets/sounds/order-notification.mp3') ?>">
    ...
    <script src="<?= versioned_asset('dashboard/assets/js/admin-dashboard.js', 'assets/js/admin-dashboard.js') ?>" defer></script>
