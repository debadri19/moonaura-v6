...
/* ===================================================================
   ...
   dashboard/dashboard.php polls to refresh its Recent Orders panel
   without a full page reload. Deliberately does nothing else:
   - No writes, no state changes - a single SELECT, same shape and
     same columns dashboard/orders.php already reads and already trusts
...
// Same columns dashboard/orders.php already selects for its list table -
