...
/* ===================================================================
   ADMIN - ORDER DETAIL
   -------------------------------------------------------------------
   Read-only - see dashboard/orders.php's doc comment for why (status
   ...
   invoice row, pointing at the new dashboard/invoice.php - a thin wrapper
   ...
   invoices that already exist, pointing at the same dashboard/invoice.php
...
<body class="admin-body">
    ...
    <script src="<?= versioned_asset('dashboard/assets/js/admin-phase-c1.js', 'assets/js/admin-phase-c1.js') ?>" defer></script>
