...
/* ===================================================================
   ...
   is already behind admin login the same way admin/order-detail.php
   ...
   attachment) so admin/order-detail.php can offer both an inline
...
// exactly as before - admin/order-detail.php now offers both, one
