(function () {
    /* ===================================================================
       ...
       1. Order Status Update      (admin/order-detail.php)
       2. Product Image Set Primary (admin/product-form.php gallery)
    =================================================================== */
    ...
    (function initOrderStatusUpdate() {
        ...
        if (!form) {
            return; // Not on admin/order-detail.php.
        }
    ...
    (function initProductImageSetPrimary() {
        ...
        if (!gallery) {
            return; // Not on admin/product-form.php, or no images yet.
        }
